...
def apriltag_video(input_streams=[0],#input_streams=['../media/input/single_tag.mp4', '../media/input/multiple_tags.mp4'], # For default cam use -> [0]
                   output_stream=False,
                   display_stream=True,
    ...
    for stream in input_streams:
        ...
        while(video.isOpened()):
            ...
            result, overlay = apriltag.detect_tags(frame,
                                                   detector,
                                                   camera_params=(1433.0825, 1435.1336, 943.7936, 546.6107),
